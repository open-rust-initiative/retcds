...
use crate::eraftpb::{ConfChange, ConfChangeSingle, ConfChangeTransition, ConfChangeType, ConfChangeV2, Entry};
use std::borrow::Cow;
use std::fmt::Write;
use bytes::Bytes;
use protobuf::Message;
use crate::eraftpb::EntryType::EntryConfChangeV2;
use crate::prelude::EntryType::EntryConfChange;
...
impl ConfChangeI for ConfChange {
    ...
    fn to_entry(&self) -> Entry {
        ...
        entry.set_entry_type(EntryConfChange);
        entry
    }
}
...
impl ConfChangeI for ConfChangeV2 {
    ...
    fn to_entry(&self) -> Entry {
        ...
        let mut entry = Entry::new();
        entry.set_data(Bytes::from(data));
        entry.set_entry_type(EntryConfChangeV2);
        entry
    }
